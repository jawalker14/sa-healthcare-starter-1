...
const WhatsAppCTA: React.FC = () => {
    ...
    const whatsappHref = buildWhatsAppUrl(contacts.whatsapp || contacts.phone, 'Hello, I would like to enquire about your services.');

    return (
        <div className="fixed bottom-5 right-5 z-40">
            <a
                href={whatsappHref}
                className="flex items-center justify-center h-14 w-14 bg-teal-500 text-white rounded-full shadow-soft hover:shadow-soft-lg hover:bg-teal-600 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-teal-500 transition duration-250 ease-gentle"
                aria-label="Chat with us on WhatsApp"
                data-cta="whatsapp_floating"
                onClick={() => { trackWhatsAppClick('floating'); pixelContact('whatsapp'); }}
            >
